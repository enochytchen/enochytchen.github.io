...
log using "Your Log folder route/exercise2_`todaydate'.log", replace
...
CREATED: 20210201 Enoch Chen (Remember to change it to your name)	 
UPDATED: 20210201 Enoch Chen (Remember to change it to your name)		
